...
@__const.main.myNumbers = private unnamed_addr constant [4 x i32] [i32 25, i32 50, i32 75, i32 100], align 4
...
define i32 @main() #0 {
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr align 4 %2, ptr align 4 @__const.main.myNumbers, i64 16, i1 false)
